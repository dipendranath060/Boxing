        ...
        <div class="row mb-3 justify-content-center">
            <div class="col-lg-7">
                <div class="add-form bg-white p-4 rounded">
                    <h2 class="mb-5 section-title border-bottom pb-1">Add a New Album</h2>
                    @if ($errors->any())
                    ...
                    <form action="{{url('admin/add-gallery')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" value="{{old('title')}}" id="title" class="w-100" placeholder="Enter album title..." required>
                        </div>
                        
                        <div class="mb-3">
                            <label for="slug" class="fs-5 mb-2">Album Slug</label>
                            <input type="text" name="album_slug" value="{{old('album_slug')}}" id="slug" class="w-100" placeholder="Enter album title..." required>
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary mb-1">Add Album</button>
