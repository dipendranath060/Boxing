...
@section('title', 'Add | Field Coordinator-Member')
@section('content')
    ...
    <div class="container">
        <nav aria-label="breadcrumb" class="p-2 bg-white breadcrumb-main rounded">
            <ol class="breadcrumb m-0 justify-content-start">
                ...
                <li class="breadcrumb-item active" aria-current="page">Add Field Coordinator-Member</li>
            </ol>
        </nav>
    </div>
</div>

<!-- coordinator-Member Add Form -->
<div class="counter-container py-3">
    <div class="container">
        <div class="row mb-3 justify-content-center">
            <div class="col-lg-7">
                <div class="add-form bg-white p-4 rounded">
                    <h2 class="mb-5 section-title border-bottom pb-1">Add a Field Coordinator-Member</h2>
                    @if ($errors->any())
                    ...
                    @endif
                    <form action="{{url('admin/add-field-coordinator-member')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <label for="name" class="fs-5 mb-2">Name</label>
                            <input type="text" name="name" value="{{old('name')}}" id="name" class="w-100" placeholder="Enter Field Coordinator member name..." required>
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary mb-1">Add Field Coordinator-Member</button>
