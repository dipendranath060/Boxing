        ...
        <div class="row mb-3 justify-content-center">
            <div class="col-lg-7">
                <div class="add-form bg-white p-4 rounded">
                    <h2 class="mb-5 section-title border-bottom pb-1">Add Document</h2>
                    @if ($errors->any())
                    ...
                    @endif
                    <form action="{{url('admin/add-document')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <label for="title" class="fs-5 mb-2">Title</label>
                            <input type="text" name="title" value="{{old('title')}}" id="title" class="w-100" placeholder="Enter document title..." required>
                        </div>
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-primary mb-1">Add Document</button>
